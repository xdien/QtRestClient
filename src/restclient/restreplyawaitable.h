...
public:
  ...
  //! Converts the error data to a string using the transformer if neccessary
  //! and returns it
  QString errorString(
      const std::function<QString(QVariantMap, int)> &failureTransformer) const;
  //! @copybrief AwaitedException::errorString(const
  //! std::function<QString(QVariantMap, int)> &) const
  QString errorString(const std::function<QString(QVariantList, int)>
                          &failureTransformer) const;
...
//! [QtCoroutines](https://github.com/Skycoder42/QtCoroutines) to await a rest
//! reply
...
public:
  ...
  //! @copybrief AwaitedException::errorString(const
  //! std::function<QString(QVariantMap, int)> &) const
  QString errorString(const std::function<QString(ErrorClassType, int)>
                          &failureTransformer) const;
...
//! A helper class to be used with
//! [QtCoroutines](https://github.com/Skycoder42/QtCoroutines) to await a
//! generic rest reply
...
public:
  ...
  GenericRestReplyAwaitable(
      GenericRestReply<DataClassType, ErrorClassType> *reply);
  //! Move constructor
  GenericRestReplyAwaitable(
      GenericRestReplyAwaitable<DataClassType, ErrorClassType>
          &&other) noexcept;
  //! Move assignment operator
  GenericRestReplyAwaitable &
  operator=(GenericRestReplyAwaitable<DataClassType, ErrorClassType>
                &&other) noexcept;
...
public:
  //! @copybrief
  //! GenericRestReplyAwaitable::GenericRestReplyAwaitable(GenericRestReply<DataClassType,
  //! ErrorClassType> *)
  GenericRestReplyAwaitable(GenericRestReply<void, ErrorClassType> *reply);
  //! @copybrief
  //! GenericRestReplyAwaitable::GenericRestReplyAwaitable(GenericRestReplyAwaitable<DataClassType,
  //! ErrorClassType> &&)
  GenericRestReplyAwaitable(
      GenericRestReplyAwaitable<void, ErrorClassType> &&other) noexcept;
  //! @copybrief
  //! GenericRestReplyAwaitable::operator=(GenericRestReplyAwaitable<DataClassType,
  //! ErrorClassType> &&)
  GenericRestReplyAwaitable &
  operator=(GenericRestReplyAwaitable<void, ErrorClassType> &&other) noexcept;
...
GenericRestReplyAwaitable<DataClassType, ErrorClassType>::
    GenericRestReplyAwaitable(
        GenericRestReply<DataClassType, ErrorClassType> *genericReply)
    : reply{genericReply} {}
...
GenericRestReplyAwaitable<DataClassType, ErrorClassType>::
    GenericRestReplyAwaitable(
        GenericRestReplyAwaitable<DataClassType, ErrorClassType>
            &&other) noexcept
    : reply{other.reply}, successResult{std::move(other.successResult)} {
  errorResult.swap(other.errorResult);
}

template <typename DataClassType, typename ErrorClassType>
GenericRestReplyAwaitable<DataClassType, ErrorClassType> &
GenericRestReplyAwaitable<DataClassType, ErrorClassType>::operator=(
    GenericRestReplyAwaitable<DataClassType, ErrorClassType> &&other) noexcept {
  reply = other.reply;
...
template <typename DataClassType, typename ErrorClassType>
void GenericRestReplyAwaitable<DataClassType, ErrorClassType>::prepare(
  ...
  reply->onSerializeException([this, resume](
                                  const QtJsonSerializer::Exception &data) {
    errorResult.reset(new exceptionType{0, RestReply::Error::Deserialization,
                                        QString::fromUtf8(data.what())});
    resume();
  });
  reply->onError([this, resume](const QString &message, int code,
                                RestReply::Error errorType) {
...
template <typename DataClassType, typename ErrorClassType>
typename GenericRestReplyAwaitable<DataClassType, ErrorClassType>::type
GenericRestReplyAwaitable<DataClassType, ErrorClassType>::result() {
  if (errorResult) {
    errorResult->raise();
    Q_UNREACHABLE();
  } else
...
template <typename ErrorClassType>
GenericRestReplyAwaitable<void, ErrorClassType>::GenericRestReplyAwaitable(
    GenericRestReply<void, ErrorClassType> *genericReply)
    : reply{genericReply} {}
...
template <typename ErrorClassType>
GenericRestReplyAwaitable<void, ErrorClassType> &
GenericRestReplyAwaitable<void, ErrorClassType>::operator=(
    GenericRestReplyAwaitable<void, ErrorClassType> &&other) noexcept {
  reply = other.reply;
  errorResult.swap(other.errorResult);
  return *this;
...
template <typename ErrorClassType>
void GenericRestReplyAwaitable<void, ErrorClassType>::prepare(
    const std::function<void()> &resume) {
...
template <typename ErrorClassType>
typename GenericRestReplyAwaitable<void, ErrorClassType>::type
GenericRestReplyAwaitable<void, ErrorClassType>::result() {
  if (errorResult) {
    errorResult->raise();
    Q_UNREACHABLE();
  }
...
template <typename ErrorClassType>
GenericAwaitedException<ErrorClassType>::GenericAwaitedException(
    int code, const ErrorClassType &data)
    : AwaitedException{code, RestReply::Error::Failure,
                       QVariant::fromValue<ErrorClassType>(data)} {}

template <typename ErrorClassType>
GenericAwaitedException<ErrorClassType>::GenericAwaitedException(
    int code, RestReply::Error type, const QString &data)
...
template <typename ErrorClassType>
QString GenericAwaitedException<ErrorClassType>::errorString(
...
template <typename DataClassType, typename ErrorClassType>
GenericRestReplyAwaitable<DataClassType, ErrorClassType>
GenericRestReplyBase<DataClassType, ErrorClassType>::awaitable() {
  return GenericRestReplyAwaitable<DataClassType, ErrorClassType>{
      static_cast<TInstance *>(this)};
}
#endif
